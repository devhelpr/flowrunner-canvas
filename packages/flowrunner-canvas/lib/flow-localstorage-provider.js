...
function setDefaultFlow(flowPackage) {
    defaultFlow = flowPackage;
}
function setAdditionalTasks(tasks) {
...
export const flowrunnerStorageProvider = {
...
export const configurableFlowrunnerStorageProvider = {
    storeFlowPackage: storeFlowPackage,
    getFlowPackage: getFlowPackage,
    getFlows: getFlows,
    getFlow: getFlow,
...
export const readOnlyFlowrunnerStorageProvider = {
    storeFlowPackage: storeFlowPackage,
    getFlowPackage: () => {
        if (isReadOnly) {
            return JSON.parse(getDefaultFlow());
...
//# sourceMappingURL=flow-localstorage-provider.js.map