...
export const Circle = React.forwardRef((props, ref) => {
    ...
    return _jsx(_Fragment, { children: _jsxs(Group, { x: props.x, y: props.y, ref: groupRef, "data-id": props.name, draggable: false, onDragStart: props.onDragStart, onDragMove: props.onDragMove, onDragEnd: props.onDragEnd, onClick: props.onClickShape, onTouchStart: props.onTouchStart, onTouchMove: props.onTouchMove, onTouchEnd: props.onTouchEnd, onMouseDown: props.onMouseStart, onMouseMove: props.onMouseMove, onMouseUp: props.onMouseEnd, onMouseOver: props.onMouseOver, onMouseOut: props.onMouseOut, onMouseLeave: props.onMouseLeave, opacity: props.canvasHasSelectedNode && !props.isSelected && !props.isConnectedToSelectedNode ? 1 : 1, transformsEnabled: "position", children: [_jsx(KonvaCircle, { x: ShapeMeasures.circleSize / 2, y: ShapeMeasures.circleSize / 2, radius: ShapeMeasures.circleSize, stroke: settings.strokeColor, strokeWidth: 4, width: ShapeMeasures.circleSize, height: ShapeMeasures.circleSize, fill: props.isSelected ? settings.fillSelectedColor : settings.fillColor, transformsEnabled: "position", perfectDrawEnabled: false }), _jsx(Text, { x: 0, y: 0, text: props.node && props.node.label ? props.node.label : props.name, align: 'center', width: ShapeMeasures.circleSize, height: ShapeMeasures.circleSize, verticalAlign: "middle", listening: false, wrap: "none", fontSize: 18, ellipsis: true, fill: settings.textColor, transformsEnabled: "position", perfectDrawEnabled: false })] }) });
});
