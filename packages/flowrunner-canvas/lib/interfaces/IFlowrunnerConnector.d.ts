...
export interface IFlowrunnerConnector {
    ...
    modifyFlowNode: (nodeName: string, propertyName: string, value: any, executeNode?: string, eventName?: string, additionalValues?: any, isBundledNode?: boolean, bundleNodeId?: string) => void;
