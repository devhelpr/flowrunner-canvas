...
const DebugNodeHtmlPlugin = React.lazy(() => import('./html-plugins/debug-node').then(({ DebugNodeHtmlPlugin }) => ({ default: DebugNodeHtmlPlugin })));
const GridEditNodeHtmlPlugin = React.lazy(() => import('./html-plugins/grid-edit').then(({ GridEditNodeHtmlPlugin }) => ({ default: GridEditNodeHtmlPlugin })));
