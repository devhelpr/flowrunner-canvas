    ...
    <div className={`form-group ${props.fieldIndex > 0 ? 'tw-mt-2 tw-mb-2' : 'tw-mb-2'}`}>
      <button
        ...
        onClick={(event) => {
          ...
          const stateMachine = getCurrentStateMachine(props.metaInfo.stateMachine);
          if (stateMachine && stateMachine.stateMachine) {
            stateMachine.stateMachine.event(metaInfo.defaultValue, props.payload);
          }
          return false;
        }}
      >
