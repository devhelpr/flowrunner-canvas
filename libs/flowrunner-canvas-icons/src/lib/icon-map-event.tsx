...
export const IconMapEvent = (_props: any) => (
  <svg width="790" height="70" viewBox="0 0 790 70" fill="none">
    ...
    <path d="M410 34L395 25.3397V42.6603L410 34ZM383 35.5H396.5V32.5H383V35.5Z" fill="currentColor" />
  </svg>
);
